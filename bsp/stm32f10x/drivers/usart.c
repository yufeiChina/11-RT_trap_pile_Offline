...
/* USART5 */
#define UART5_GPIO_TX        GPIO_Pin_12        //GPC12
#define UART5_GPIO_RX        GPIO_Pin_2         //GPD2
...
#if defined(RT_USING_UART1)
    uart = &uart1;
   // config.baud_rate = BAUD_RATE_9600;      //串口屏波特率9600
    config.baud_rate = BAUD_RATE_115200;    //用作打印波特率 115200
    ...
    //config.baud_rate = BAUD_RATE_115200;        //CPU刷卡器波特率 115200
    config.baud_rate = BAUD_RATE_19200;         //M1卡波特率 19200
...
#if defined(RT_USING_UART5)
    uart = &uart5;
    config.baud_rate = BAUD_RATE_115200;//BAUD_RATE_115200;
